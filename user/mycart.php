        ...
        <nav class="navbar navbar-expand-lg">
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between">
                <div class="navbar-header">
                    ...
                    <a href="index.html" class="navbar-brand">
                        <div class="brand-text brand-big visible text-uppercase"><strong
                                class="text-primary">Main</strong><strong>Dashboard</strong></div>
                ...
                <div class="right-menu list-inline no-margin-bottom">
                    ...
                    <!-- Go to website -->
                    <div class="list-inline-item"> <a id="website" title="Go to website" href="../dealership/index.php"
                            class="nav-link">Buy Cars <i class="fa fa-globe"></i></a></div>
                    <!-- Log out               -->
    ...
    <div class="d-flex align-items-stretch">
        ...
        <nav id="sidebar">
            ...
            <div class="sidebar-header d-flex align-items-center">
                <div class="avatar"><img src="img/avatar-6.jpg" title="Profile picture" alt="..."
            ...
            <ul class="list-unstyled">
                ...
                <li>
                    <a href="deleteaccount.php" title="Delete account"> <i class="fa fa-minus-circle"></i>Delete My
                        Account </a>
                </li>
            </ul>
                                    ...
                                    <table id="cartTable" class="table table-striped table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center;" class="text-info"> <i
                                                        class="fa fa-trash"></i> </th>
                                                <th style="text-align: center;" class="text-info"><i
                                                        class="fa fa-shopping-cart"></i></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            if ($result) {
                                                while ($row = mysqli_fetch_array($result)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form style="text-align: center;" action="../api/deleteFromCart.php"
                                                                method="POST">
                                                                <input type="hidden" name="cartId"
                                                                    value="<?php echo $cart_id; ?>">
                                                                <input type="submit" name="deleteFromCart" value="Remove"
                                                                    class="btn btn-outline-danger">
                                                            </form>
                                                        </td>
                                                        <td>
                                                            <form style="text-align: center;" action="../api/buyVehicle.php"
                                                                method="POST">
