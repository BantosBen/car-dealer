...
if (!isset($_POST['vehicle_id']) && !isset($_POST['make_id']) && !isset($_POST['quantity'])) {
    ...
    header("location:../home/details.php?Invalid= Some values are missing.");
} else {
    ...
    if ($result == 1) {
        ...
        header("location:../home/wishlist.php?Invalid= Something went wrong. Couldn't add to the wishlist.");
    }
}
